...
namespace fCraft {
    partial class Player {
        ...
        // Team9000
        public static event EventHandler<CheckingPlayerLoginEventArgs> CheckingPlayerLogin;
        static int RaiseCheckingPlayerLoginEvent(Player player, String name, String verificationCode) {
            ...
            if (args.Abort) return 1;
            if (args.Verify) return 2;
            return 0;
        }
    }
}
...
namespace fCraft.Events {
    ...
    // Team9000
    public sealed class CheckingPlayerLoginEventArgs : EventArgs {
        internal CheckingPlayerLoginEventArgs(Player player, String name, String verificationCode) {
            Player = player;
            Name = name;
